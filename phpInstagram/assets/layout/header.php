...
$follow_count=mysqli_num_rows(mysqli_query($connect,$sql));
    ...
    <nav>
        ...
        <ul>
            <li>
                ...
                <a href="../../index.php">
                    <svg aria-label="Главная" class="_ab6-" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24"
                         role="img"
            ...
            <li>
                ...
                <a href="../../pages/search.php">
                    <svg aria-label="Поисковый запрос" class="_ab6-" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)"
                         height="24"
            ...
            <li>
                ...
                <a href="../../pages/allposts.php">
                    <svg aria-label="Интересное" class="_ab6-" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24"
                         role="img"
                         viewBox="0 0 24 24" width="24">
            ...
            <li>
                <a href="../../pages/chat.php">
                    <svg aria-label="Messenger" class="_ab6-" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24"
                         role="img"
                         viewBox="0 0 24 24" width="24">
            ...
            <li>
                <a href="../../pages/notificaton.php">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                         class="bi bi-bell" viewBox="0 0 16 16">
                        <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zM8 1.918l-.797.161A4.002 4.002 0 0 0 4 6c0 .628-.134 2.197-.459 3.742-.16.767-.376 1.566-.663 2.258h10.244c-.287-.692-.502-1.49-.663-2.258C12.134 8.197 12 6.628 12 6a4.002 4.002 0 0 0-3.203-3.92L8 1.917zM14.22 12c.223.447.481.801.78 1H1c.299-.199.557-.553.78-1C2.68 10.2 3 6.88 3 6c0-2.42 1.72-4.44 4.005-4.901a1 1 0 1 1 1.99 0A5.002 5.002 0 0 1 13 6c0 .88.32 4.2 1.22 6z"/>
                        <circle cx="10" cy="9" r="5.4" fill="red" />
                        <text x="10" y="12" font-size="8" fill="white" text-anchor="middle"><?= $follow_count?></text>
                    </svg>
            ...
            <li>
                <a href="../../pages/addpost.php">
                    <svg aria-label="Новая публикация" class="_ab6-" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24" role="img" viewBox="0 0 24 24" width="24">
        ...
        <div id="more" class="dropbox">
            <svg aria-label="Настройки" class="dropbox-btn" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24"
                 role="img"
                 viewBox="0 0 24 24" width="24">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function toggleDropdown() {
            if (dropdown.style.display === 'flex') {
                ...
                dropbox.classList.remove('clicked');
            } else {
                dropdown.style.display = 'flex';
                dropbox.classList.add('clicked');
            }
        }

        // Toggle the dropdown when clicking on "More"
